...
const Header = () => {
  return (
    <div className="flex flex-col md:flex-row flex-wrap bg-blue-500 rounded-lg px-6 md:px-10 lg:px-20 bg-gradient-to-br from-indigo-600 via-indigo-500 to-indigo-400">
      {/* {----left side} */}
